...
> - Triggered only from WhatsApp (e.g., "@Nanomi check my email" or "@Nanomi send an email to...")
...
>
> `@Nanomi check my recent emails`
>
> Or:
>
> `@Nanomi list my Gmail labels`
...
> - Emails to a specific address pattern (e.g., nanomi+task@gmail.com)
> - Uses Gmail's plus-addressing feature
>
> **Option C: Subject Prefix**
> - Emails with a subject starting with a keyword (e.g., "[Nanomi]")
...
Complete all Tool Mode steps above before continuing. Verify Gmail tools work by having the user test `@Nanomi check my recent emails`.
